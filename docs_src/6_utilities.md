...
| 12    | sfonediX    | bis(halo aryl)sulfone                              |
| 13    | BzodiF      | bis(fluoro aryl)ketone                             | 
...
|-------|-------------|----------------------------------------------------|
| 51    | diepo       | diepoxide                                          |
| 52    | diCOOH      | dicarboxylic acid and acid halide                  |
| 53    | diol        | primary and secodary diol, dithiol and phenol      |
| 54    | diamin      | diamine                                            |
| 55    | diNCO       | diisocyanate                                       |
| 56    | dicAnhyd    | bis(cyclic carboxylic acid anhydride)              |
| 57    | pridiamin   | primary diamine                                    |
| 58    | diol_b      | primary and secodary diol, phenol                  |
