# 6. utilities; Overview

.ipynb files in directiry "utirities" are tools to imprementing the rules of monomer extraction-sllasification (1_MonomerDefiner.ipynb), polymerization reaction definition (2_Ps_rxnL.ipynb) and polymer generation (3_Ps_GenL.ipynb).  
